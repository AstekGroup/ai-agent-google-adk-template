#!/usr/bin/env python3
"""Script pour lancer l'agent parallèle de manière interactive."""
...
async def main():
    ...
    print("🤖 Agent Parallèle (Recherche parallèle + Fusion) démarré!")
    ...
    while True:
        try:
            ...
            # Exécuter l'agent
            print("\n🤔 Traitement en cours (Recherche parallèle → Fusion)...\n")
            events = []
