"""Script de déploiement pour Loop Agent."""
...
def deploy():
    ...
    wheel_path = Path(__file__).parent / "loop_agent-1.0.0-py3-none-any.whl"
    ...
    reasoning_engine = agent_engines.ReasoningEngine.create(
        reasoning_engine={
            ...
            "source": {
                ...
                "entrypoint": "loop_agent.agent:root_agent",
            },
        }
    )
