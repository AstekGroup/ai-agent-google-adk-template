#!/usr/bin/env python3
"""Script pour lancer l'agent avec boucle de manière interactive."""
...
async def main():
    ...
    print("🤖 Agent avec Boucle d'Amélioration Itérative démarré!")
    ...
    while True:
        try:
            ...
            # Exécuter l'agent
            print("\n🤔 Traitement en cours (Génération → [Critique → Refinement]×N)...\n")
            events = []
